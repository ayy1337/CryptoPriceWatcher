...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gainView.horizontalHeader().setDefaultSectionSize(60)
        self.gainView.horizontalHeader().setMinimumSectionSize(55)
        ...
        self.lossView.horizontalHeader().setDefaultSectionSize(60)
        self.lossView.horizontalHeader().setMinimumSectionSize(55)
        ...
        self.favouritesView.horizontalHeader().setDefaultSectionSize(60)
        self.favouritesView.horizontalHeader().setMinimumSectionSize(55)
